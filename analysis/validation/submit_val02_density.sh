#!/bin/bash
#SBATCH --job-name=hgcal_val02_den
#SBATCH --time=2:00:00
#SBATCH --nodes=1
#SBATCH --ntasks=1
...
#SBATCH --gres=gpu:1
#SBATCH --output=/users/jjchun/scratch/hgcal_cl/logs/val02_density_%j.out
#SBATCH --error=/users/jjchun/scratch/hgcal_cl/logs/val02_density_%j.err
...
OUT_DIR=${VAL_DIR}/dfs/val02_density
...
echo "=== Running DF_maker (density) on all 5 val files ==="
